...
INT INTERNAL(strtol)(nptr, endptr, base, group) const STRING_TYPE *nptr;
STRING_TYPE **endptr;
int base;
int group;
{
  ...
  if (overflow == 0 && i > (negative ? -((unsigned LONG int)(LONG_MIN + 1)) + 1
...
/* Prototype.  */
INT strtol __P((const STRING_TYPE *nptr, STRING_TYPE **endptr, int base));

INT strtol(nptr, endptr, base) const STRING_TYPE *nptr;
STRING_TYPE **endptr;
int base;
